...
class SpectralConv3d_Uno(nn.Module):
    ...
    def forward(self, x, dim1 = None,dim2=None,dim3=None):
        ...
        # print('x_ft[:, :, :self.modes1, :self.modes2, :self.modes3]', x_ft[:, :, :self.modes1, :self.modes2, :self.modes3].shape)
...
class MLP3d(nn.Module):
    ...
    def forward(self, x, dim1, dim2, dim3):
        ...
        x = F.gelu(x)
        x = self.mlp2(x)
        x = torch.nn.functional.interpolate(x, size=(dim1, dim2, dim3), mode='trilinear', align_corners=True)
        return x
...
class OperatorBlock_3D(nn.Module):
    ...
    def forward(self,x, dim1 = None, dim2 = None, dim3 = None):
        ...
        x2_out = self.mlp(x,dim1,dim2,dim3)
        x3_out = self.w(x,dim1,dim2,dim3)
