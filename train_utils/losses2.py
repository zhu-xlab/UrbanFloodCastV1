...
def GeoPC_loss(input_data, outputH, outputPXB, outputPYB, outputPX, outputPY, z, Rain, Manning, data_condition, init_condition, data_boundary, dt, i, ub, lb):
    #Initinal
    # if i == 0:
        # _EPSILON = 1e-6
    ...
    # boundary
    data_boundary1, data_boundary2 = data_boundary[0], data_boundary[1]
    # h_c_data_boundary1 = outputH[:, :, 0:2, :]
    # h_c_data_boundary2 = outputH[:, :, :, 0:2]
    h_c_data_boundary1 = outputH[:, :, -1:, :]
    h_c_data_boundary2 = outputH[:, :, :, -1:]
    loss_b1 = loss(h_c_data_boundary1, data_boundary1)
    loss_b2 = loss(h_c_data_boundary2, data_boundary2)
    # loss_b3 = loss(h_c_data_boundary3, data_boundary3)
    # loss_b4 = loss(h_c_data_boundary4, data_boundary4)
    ...
    return loss_d, loss_b, loss_c, loss_f